...
import (
	...
	"github.com/richardsric7/go-ethereum/crypto/signify"
	"github.com/richardsric7/go-ethereum/internal/build"
...
func buildFlags(env build.Environment, staticLinking bool, buildTags []string) (flags []string) {
	var ld []string
	if env.Commit != "" {
		ld = append(ld, "-X", "github.com/richardsric7/go-ethereum/internal/version.gitCommit="+env.Commit)
		ld = append(ld, "-X", "github.com/richardsric7/go-ethereum/internal/version.gitDate="+env.Date)
	}
...
func downloadSpecTestFixtures(csdb *build.ChecksumDB, cachedir string) string {
	...
	url := fmt.Sprintf("https://github.com/richardsric7/execution-spec-tests/releases/download/v%s/%s%s", executionSpecTestsVersion, base, ext)
